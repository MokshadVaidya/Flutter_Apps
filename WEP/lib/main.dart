...
import 'package:wep/screens/quetion_post.dart';
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<Data>(
      ...
      child: MaterialApp(
        ...
        initialRoute: PostQuestion.id,
        routes: {
          MyPostPage.id: (context) => ChangeNotifierProvider<isListData>(
                create: (context) {
                  return isListData();
                },
                child: MyPostPage(),
...
//       initialRoute: PostQuestion.id,
//       routes: {
//         MyPostPage.id: (context) => MyPostPage(),
//         PostQuestion.id: (context) => PostQuestion(),
//
//       },
//     );
